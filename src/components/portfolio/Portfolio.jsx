...
const AllPortfolioContent = [
  ...
  },
  {
    ...
    title: "Contact Me",
    info: "Contact Me is a SaaS web app that allows users to receive email notifications when a form on their website is submitted. This form uses an HTML template to send a custom email to the user.",
    subTitle: "SaaS Web App",
    alterText: "Web App",
    techStack: "FastApi, Next.js, MongoDB, Redis, Python, Tailwind CSS, SMTP",
    date: "August, 2023",
    portfolioLink: "https://contact-me-topaz.vercel.app/",
    gitHubLink: "https://github.com/bmklei8p/contact-me",
  },
  {
